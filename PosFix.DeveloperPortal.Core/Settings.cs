namespace PosFix.DeveloperPortal.Core
{
    /// <summary>
    ...
    public class Settings
    {
        ...
        public string BaseUrl { get; set; }             //PosFix web servisleri API url'lerinin başlangıç bilgisidir.
        ...
        public string Version { get; set; }             // Kullandığınız PosFix API versiyonudur. 
